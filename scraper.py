...
with Browser('phantomjs') as browser:
    ...
    for id_number in ids:
        ...
        scraperwiki.sqlite.save(unique_keys=['date'], data={"length": length.strip(), "design": design, "finish": finish, "material_type": material_type, "price": price, "date": todays_date })
